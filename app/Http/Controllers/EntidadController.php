...
class EntidadController extends Controller {
    public function index() { 
        return view('entidades.index', ['entidades' => Entidad::all()]); 
    }
    ...
    public function store(Request $request) {
        ...
        Entidad::create($request->only('codigo','nombre','mision','vision','estructura','sector','subsector','nivel_gobierno','estado'));
    ...
    public function update(Request $request, Entidad $entidad) {
        $request->validate(['nombre' => 'required']);
        $entidad->update($request->only('codigo','nombre','mision','vision','estructura','sector','subsector','nivel_gobierno','estado'));
        return redirect()->route('entidades.index')->with('success', 'Entidad actualizada.');
    }
    public function destroy(Entidad $entidad) { 
        $entidad->delete(); 
        return redirect()->route('entidades.index')->with('success', 'Eliminada.'); 
    }
}