...
class ObjetivoEstrategicoController extends Controller {
    ...
    public function store(Request $request) {
        $request->validate(['codigo' => 'required', 'descripcion' => 'required', 'plan_id' => 'required|exists:planes,id']);
    ...
    public function show(ObjetivoEstrategico $objetivo) {$objetivo->load('plan', 'ods.metas.indicadores', 'pdns');return view('objetivos.show', compact('objetivo')); }
