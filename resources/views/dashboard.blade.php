...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
   ...
   @if(auth()->user()->rol?->nombre === 'Técnico de Planificación')
    ...
    <a href="{{ route('objetivos.index') }}" class="bg-teal-600 text-white rounded-lg p-4 shadow hover:bg-teal-700">
        <p class="text-3xl"></p>
        <p class="text-lg font-semibold mt-2">Objetivos</p>
        <p class="text-xs opacity-80">Objetivos estrategicos</p>
    </a>
    <a href="{{ route('ods.index') }}" class="bg-green-800 text-white rounded-lg p-4 shadow hover:bg-green-900">
        <p class="text-3xl"></p>
        <p class="text-lg font-semibold mt-2">Catalogo</p>
        <p class="text-xs opacity-80">ODS y PDN</p>
    </a>
@endif
