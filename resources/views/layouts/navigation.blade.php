        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(in_array(auth()->user()->rol?->nombre, ['Administrador','Técnico de Planificación','Revisor Institucional','Autoridad Validante','Usuario Externo']))
                    ...
                    @if(in_array(auth()->user()->rol?->nombre, ['Administrador','Auditor','Revisor Institucional','Autoridad Validante']))
